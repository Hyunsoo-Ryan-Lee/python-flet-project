...
# def main(page: ft.Page):
    ...
    def upload_files(e):
        ...
        for s3_key in s3_file_path:
            if check_file_exists_in_s3(s3_client, bucket_name, s3_key):
    ...
    upload_btn_row = ft.Row(controls=[select_file_btn, to_gallery_btn, empty_uploadDir_btn],alignment=ft.MainAxisAlignment.SPACE_BETWEEN)
